...
<body>
            ...
            <div class="swiper-wrapper">
              <?php foreach ($categorie as $cat) { ?>
                ...
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="images/<?= $cat['photo'] ?>" alt="Category Thumbnail">
                  <h3 class="category-title"><?= $cat['nom_categorie'] ?></h3>
                </a>
        ...
        <div class="col-md-12">
          ...
          <div class="bootstrap-tabs product-tabs">
            <div class="tabs-header d-flex justify-content-between border-bottom my-5">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <?php foreach ($categorie as $cat) { ?>
                    <a href="#" class="nav-link text-uppercase fs-6" id="nav-<?= $cat['id_categorie'] ?>-tab"
                      data-bs-toggle="tab"
                      data-bs-target="#nav-<?= $cat['id_categorie'] ?>"><?= $cat['nom_categorie'] ?></a>
                  <?php } ?>
                </div>
              </nav>
            </div>
            <div class="tab-content" id="nav-tabContent">
                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="images/<?= $prod['photo'] ?>" class="tab-image">
                          </a>
                        </figure>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          <div class="input-group product-qty">
                            ...
                            <input type="text" id="quantity" name="quantity" class="form-control input-number"
                              value="<?= $prod['demande'] ?>">
                            <input type="hidden" id="produit" name="produit" value="<?= $prod['id_produit'] ?>">
                            <span class="input-group-btn">
                          ...
                          <a href="#" class="nav-link add_cart">Add to Cart <iconify-icon icon="uil:shopping-cart"></a>
                        </div>
                      </div>
                    </div>
              ...
              <?php foreach ($categorie as $cat) { ?>
                <?php
                $product = get_product_cat($cat['id_categorie']);
                ?>
                <div class="tab-pane fade" id="nav-<?= $cat['id_categorie'] ?>" role="tabpanel"
                  aria-labelledby="nav-<?= $cat['id_categorie'] ?>-tab">
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    <?php foreach ($product as $prod) { ?>
                      ...
                      <div class="col">
                        <div class="product-item">
                          <span class="badge bg-success position-absolute m-3">-30%</span>
                          <a href="#" class="btn-wishlist jadore"><svg width="24" height="24">
                              <use xlink:href="#heart"></use>
                            </svg></a>
                            <span class="like"><?= $prod['jadore'] ?></span>
                          <figure>
                            <a href="index.html" title="Product Title">
                              <img src="images/<?= $prod['photo'] ?>" class="tab-image">
                            </a>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="products-carousel swiper">
            <div class="swiper-wrapper">
              <?php foreach ($produit as $prod) { ?>
                <?php if ($prod['demande'] >= 1) { ?>
                  <div class="product-item swiper-slide">
                    <span class="badge bg-success position-absolute m-3">-15%</span>
                     <input type="hidden" name="jadore_produit" value="<?= $prod['id_produit'] ?>">
                    <a href="#" class="btn-wishlist jadore"><svg width="24" height="24">
                        <use xlink:href="#heart"></use>
                      </svg></a>
                    <figure>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="products-carousel swiper">
            <div class="swiper-wrapper">
              <?php foreach ($produit as $prod) { ?>
                 <?php  var_dump($prod['jadore']);  ?>
               
                <?php if ($prod['jadore']==1){ ?>
  ...
  <script src="js/script_demande.js"></script>
  <script src="js/script_jadore.js"></script>
</body>
